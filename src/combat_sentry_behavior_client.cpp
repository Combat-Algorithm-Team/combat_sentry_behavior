...
#include "combat_sentry_behavior/combat_sentry_behavior_client.hpp"
...
: Node("sentry_behavior_client", options)
{
  ...
  action_client_ = rclcpp_action::create_client<BTExecuteTree>(this, "combat_sentry_behavior");
...
RCLCPP_COMPONENTS_REGISTER_NODE(combat_sentry_behavior::SentryBehaviorClient)