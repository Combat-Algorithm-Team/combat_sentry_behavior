...
#include "combat_sentry_behavior/combat_sentry_behavior_server.hpp"
...
int main(int argc, char * argv[])
{
  ...
  auto action_server = std::make_shared<combat_sentry_behavior::SentryBehaviorServer>(options);
